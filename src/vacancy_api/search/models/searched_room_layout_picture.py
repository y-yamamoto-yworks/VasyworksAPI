...
class SearchedRoomLayoutPicture(models.Model):
    """部屋間取図"""
    ...
    picture_type = models.ForeignKey(
        ...
        related_name='searched_room_layout_pictures',
        db_index=True,
    ...
    def get_sql_tables(cls, room_id: int, params):
        ...
        ans += ' INNER JOIN picture_type ON room_picture.picture_type_id = picture_type.id AND picture_type.is_layout = TRUE'
